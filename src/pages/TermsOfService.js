  ...
  return (
    <section>
      ...
      <div className="container-x">
        ...
        <TermsOfServiceHeader title="DAILYNEEDS TERMS AND CONDITIONS" date="Last updated [Nov 24th, 2021]" />

        <dl className="my-5 md:max-w-2xl md:mx-auto">
          <TermsOfServiceItem 
            heading="INTRODUCTION" 
            body={[
              "These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Dailyneeds (“we,” “us” or “our”), concerning your access to and use of the Dailyneeds website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). ",
          ...
          <TermsOfServiceItem 
            ...
            body={[
              "We accept the following forms of payment: bank transfer, Payment on delivery & card payment. You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in the Nigerian Naira. ",
          ...
          <TermsOfServiceItem 
            heading="GUIDELINES FOR REVIEWS" 
            body={[
          ...
          <TermsOfServiceItem 
            ...
            body={[
              ...
              { head: "Apple and Android Devices" } ,
          ...
          <TermsOfServiceItem 
            heading="DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY" 
            body={[
              { head: "Notifications" },
              "We respect the intellectual property rights of others. If you believe that any material available on or through the Site infringes upon any copyright you own or control, please immediately notify our Designated Copyright Agent using the contact information provided on the contact us page. ",
              ...
              { head: "Counter Notification" },
              "If you believe your own copyrighted material has been removed from the Site as a result of a mistake or misidentification, you may submit a written counter notification to us using the contact information provided below on the contact us page. ",
          ...
          <TermsOfServiceItem 
            ...
            body={[
              "These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the Federal Republic of Nigeria applicable to agreements made. "
            ]}
            />
          ...
          <TermsOfServiceItem 
            ...
            body={[
              "Option 1: Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in Io State, Federal Republic of Nigeria, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non convenient with respect to venue and jurisdiction in such state and federal courts. ",
              "Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than 10 years after the cause of action arose.",
            ]}
            />
