...
export default function CartEmptyIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="80px" viewBox="0 0 24 24" width="80px" fill="#000000"  className="fill-current m-auto text-yellow-500">
