...
export const TRANSLATIONS_EN = {
  ...
  _store: {
    ...
    Store_register_note: 'Register to sell your amazing products on our platform',
    Store_login_note: 'Log in and continue making amazing sales',
  ...
  _empty: {
    ...
    No_product_variant: 'No product variant',
    No_review: 'No review',
    No_order: 'No order',
  ...
  _errors: {
    ...
    This_token_is_invalid: 'This token is invalid',
