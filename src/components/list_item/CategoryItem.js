  ...
  return (
    <li className="mb-2">
      <Link 
        ...
        className={`${grid ? 'block text-center' : 'flex'} flex-grow items-center gap-2 bg-color py-2 rounded md:px-2 md:py-3 md:shadow md:block md:text-center hover:bg-color-gray-h ${iconColor}`}
        >
